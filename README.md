...
**2026-09-07 17:42 用户反馈后的修复正在进行，尚未完成验收。**
此前 main 已合并并推送至 `3bfc72b`；这不代表本轮修复已提交或推送。
用户报告拔掉 USB 后无线同步可用，但 Mac 重处理未回到 iPhone、Mac 本地声纹缺失、iPhone 长时间 Identifying 及交互问题仍待修复和验证。
